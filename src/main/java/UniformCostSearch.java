...
public class UniformCostSearch {
    ...
    // define a priority queue (min heap) that always returns a node with the smallest g value
    ...
    public Result search(Node root, int[][] goal){
        ...
        while(!minHeap.isEmpty()){
            ...
            if(row - 1 >= 0){
                ...
                newGrid[row - 1][col] = 0;
                Node newNode = new Node(newGrid, row - 1, col, cost);
            ...
            if(col - 1 >= 0){
                ...
                newGrid[row][col - 1] = 0;
                Node newNode = new Node(newGrid, row, col - 1, cost);
